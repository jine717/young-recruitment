...
import { Plus, Trash2, ArrowLeft, ArrowUp, ArrowDown, Save } from 'lucide-react';
...
export default function BusinessCaseEditor() {
  ...
  const handleMoveQuestion = async (index: number, direction: 'up' | 'down') => {
    ...
    // Update both questions with swapped numbers
    ...
    <AdminLayout>
      <div className="space-y-6 max-w-4xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground">Business Case Questions</h2>
            <p className="text-muted-foreground">
              {job?.title || 'Loading...'} - Configure video questions for candidates
            </p>
          </div>
        </div>
